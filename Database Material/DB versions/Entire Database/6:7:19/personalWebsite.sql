...
--
-- Host: localhost
-- Generation Time: Jul 06, 2019 at 12:34 AM
...
CREATE TABLE `Experience` (
  ...
  `github` varchar(100) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `Experience` (`uniqueKey`, `name`, `experienceYearFK`, `experienceDescription`, `languageOneFK`, `languageTwoFK`, `languageThreeFK`, `languageFourFK`, `languageFiveFK`, `Link`, `github`) VALUES
(0, 'Yumyum House', 3, 'Built a fully functional online ordering system.', 0, 1, 2, 5, 6, 'yumyumhouselimited.com', 'https://github.com/hawadlu/Yumyum-House'),
(1, 'Test', 2, 'Testing testing testing', 9, 2, 3, 1, 7, '0', '0'),
(2, 'Test', 2, 'Testing testing testing', 9, 2, 3, 1, 7, 'google.com', '0'),
(3, 'Test', 2, 'Testing testing testing', 9, 2, 3, 1, 7, 'google.com', '0'),
(4, 'Test', 2, 'Testing testing testing', 9, 2, 3, 1, 7, 'google.com', '0');
...
INSERT INTO `Institution` (`institutionPK`, `institution`) VALUES
(0, 'Victoria University of Wellington'),
(1, 'Tawa College');
...
INSERT INTO `Projects` (`uniqueKey`, `name`, `projectYearFK`, `link`, `projectDescription`, `languageOneFK`, `languageTwoFK`, `languageThreeFK`, `languageFourFk`, `languageFiveFK`, `github`) VALUES
(0, 'Calculator', 4, 'https://github.com/hawadlu/Calculator', 'A simple android calculator', 3, 4, 10, 10, 10, '0'),
(1, 'Test', 4, 'google.com', 'Testing testing testing', 0, 5, 3, 4, 10, '0'),
(2, 'Test', 4, 'google.com', 'Testing testing testing', 0, 5, 3, 4, 10, '0'),
(3, 'Test', 4, 'google.com', 'Testing testing testing', 0, 5, 3, 4, 10, '0'),
(4, 'Test', 4, '0', 'Testing testing testing', 0, 5, 3, 4, 10, '0');
...
--
ALTER TABLE `Languages`
  MODIFY `languagePK` tinyint(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `relevantYear`
--
ALTER TABLE `relevantYear`
  MODIFY `relevantYearPK` tinyint(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `subjectAbbreviation`
--
ALTER TABLE `subjectAbbreviation`
  MODIFY `subjectAbbreviationPK` tinyint(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `subjectLevel`
--
ALTER TABLE `subjectLevel`
  MODIFY `subjectLevelPK` tinyint(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
