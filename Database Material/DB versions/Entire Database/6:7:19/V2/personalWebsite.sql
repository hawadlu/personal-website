...
--
-- Host: localhost
-- Generation Time: Jul 06, 2019 at 01:17 AM
...
CREATE TABLE `Examples` (
  ...
  `exampleYearFK` tinyint(2) NOT NULL,
  `examplesDescription` varchar(255) NOT NULL,
...
INSERT INTO `Examples` (`uniqueKey`, `name`, `exampleYearFK`, `examplesDescription`, `languageOneFK`, `languageTwoFK`, `languageThreeFK`, `languageFourFK`, `languageFiveFK`, `Link`, `github`) VALUES
...
ALTER TABLE `Examples`
  ADD UNIQUE KEY `uniqueKey` (`uniqueKey`),
  ADD KEY `Experience_fk0` (`exampleYearFK`),
...
--
ALTER TABLE `Examples`
  ADD CONSTRAINT `Experience_fk0` FOREIGN KEY (`exampleYearFK`) REFERENCES `relevantYear` (`relevantYearPK`),
