...
--
-- Host: localhost
-- Generation Time: Jul 05, 2019 at 12:51 AM
...
INSERT INTO `Experience` (`uniqueKey`, `name`, `experienceYearFK`, `experienceDescription`, `languageOneFK`, `languageTwoFK`, `languageThreeFK`, `languageFourFK`, `languageFiveFK`, `Link`) VALUES
(0, 'Yumyum House', 3, 'Built a fully functional online ordering system.', 0, 1, 2, 5, 6, 'yumyumhouselimited.co.nz');
...
INSERT INTO `Projects` (`uniqueKey`, `name`, `projectYearFK`, `link`, `projectDescription`, `languageOneFK`, `languageTwoFK`, `languageThreeFK`, `languageFourFk`, `languageFiveFK`) VALUES
(0, 'Calculator', 4, 'https://github.com/hawadlu/Calculator', 'A simple android calculator', 3, 4, 10, 10, 10);
